...
impl CreditCardLiability {
    ...
    pub fn new(account_id: Option<String>, aprs: Vec<crate::models::Apr>, is_overdue: Option<bool>, last_payment_amount: f32, last_payment_date: Option<String>, last_statement_issue_date: String, last_statement_balance: f32, minimum_payment_amount: f32, next_payment_due_date: Option<String>) -> CreditCardLiability {
        CreditCardLiability {
            account_id,
            aprs,
            is_overdue,
