...
pub struct DepositSwitchGetResponse {
    ...
    pub percent_allocated: Option<f32>,
    ...
    pub amount_allocated: Option<f32>,
...
impl DepositSwitchGetResponse {
    ...
    pub fn new(deposit_switch_id: String, target_account_id: Option<String>, target_item_id: Option<String>, state: State, account_has_multiple_allocations: Option<bool>, is_allocated_remainder: Option<bool>, percent_allocated: Option<f32>, amount_allocated: Option<f32>, date_created: String, date_completed: Option<String>, request_id: String) -> DepositSwitchGetResponse {
        DepositSwitchGetResponse {
            deposit_switch_id,
            target_account_id,
            target_item_id,
