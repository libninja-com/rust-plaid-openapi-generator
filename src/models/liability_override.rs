...
pub struct LiabilityOverride {
    ...
    pub minimum_payment_amount: f32,
...
impl LiabilityOverride {
    ...
    pub fn new(_type: String, purchase_apr: f32, cash_apr: f32, balance_transfer_apr: f32, special_apr: f32, last_payment_amount: f32, minimum_payment_amount: f32, is_overdue: bool, origination_date: String, principal: f32, nominal_apr: f32, interest_capitalization_grace_period_months: f32, repayment_model: crate::models::StudentLoanRepaymentModel, expected_payoff_date: String, guarantor: String, is_federal: bool, loan_name: String, loan_status: crate::models::StudentLoanStatus, payment_reference_number: String, pslf_status: crate::models::PslfStatus, repayment_plan_description: String, repayment_plan_type: String, sequence_number: String, servicer_address: crate::models::Address) -> LiabilityOverride {
        LiabilityOverride {
            _type,
            purchase_apr,
            cash_apr,
