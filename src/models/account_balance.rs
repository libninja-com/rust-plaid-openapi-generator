...
impl AccountBalance {
    ...
    pub fn new(available: Option<f32>, current: Option<f32>, limit: Option<f32>, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> AccountBalance {
        AccountBalance {
            available,
            current,
            limit,
