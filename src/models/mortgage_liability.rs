...
pub struct MortgageLiability {
    ...
    pub current_late_fee: Option<f32>,
    /// Total amount held in escrow to pay taxes and insurance on behalf of the borrower.
    #[serde(rename = "escrow_balance")]
    pub escrow_balance: Option<f32>,
    ...
    pub next_monthly_payment: Option<f32>,
    ...
    pub past_due_amount: Option<f32>,
...
impl MortgageLiability {
    ...
    pub fn new(account_id: String, account_number: String, current_late_fee: Option<f32>, escrow_balance: Option<f32>, has_pmi: Option<bool>, has_prepayment_penalty: Option<bool>, interest_rate: crate::models::MortgageInterestRate, last_payment_amount: Option<f32>, last_payment_date: Option<String>, loan_type_description: Option<String>, loan_term: Option<String>, maturity_date: Option<String>, next_monthly_payment: Option<f32>, next_payment_due_date: Option<String>, origination_date: Option<String>, origination_principal_amount: Option<f32>, past_due_amount: Option<f32>, property_address: crate::models::MortgagePropertyAddress, ytd_interest_paid: Option<f32>, ytd_principal_paid: Option<f32>) -> MortgageLiability {
        MortgageLiability {
            account_id,
            account_number,
            current_late_fee,
