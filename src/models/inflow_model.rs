...
/// InflowModel : The `inflow_model` allows you to foo a test account that receives regular income or make regular payments on a loan. Any transactions generated by the `inflow_model` will appear in addition to randomly generated test data or transactions specified by `override_accounts`.
...
impl InflowModel {
    ...
    pub fn new(_type: String, income_amount: f32, payment_day_of_month: f32, transaction_name: String, statement_day_of_month: String) -> InflowModel {
        InflowModel {
            _type,
            income_amount,
