...
pub struct OverrideAccounts {
    ...
    pub force_available_balance: f32,
...
impl OverrideAccounts {
    ...
    pub fn new(_type: crate::models::OverrideAccountType, subtype: Option<crate::models::AccountSubtype>, starting_balance: f32, force_available_balance: f32, currency: String, meta: crate::models::Meta, numbers: crate::models::Numbers, transactions: Vec<crate::models::TransactionOverride>, identity: crate::models::OwnerOverride, liability: crate::models::LiabilityOverride, inflow_model: crate::models::InflowModel) -> OverrideAccounts {
        OverrideAccounts {
            _type,
            subtype,
            starting_balance,
