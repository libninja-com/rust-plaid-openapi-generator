...
impl TransactionBase {
    ...
    pub fn new(account_id: String, amount: f32, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, date: String, pending: bool, transaction_id: String) -> TransactionBase {
        TransactionBase {
